...
React.render(
	React.createElement(RecipeApp, {recipes: recipes}),
	document.getElementById('app')
);


},{"./components/RecipeApp":3,"react":161}],2:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
		...
		return (
			React.createElement("div", {className: "recipe"}, 
				React.createElement("h2", null, 
					React.createElement("a", {href: "#"}, rec.name)
				)
			)
		);
	}
...
var RecipeApp = React.createClass({displayName: "RecipeApp",
	render: function() {
		...
		return (
			React.createElement("div", {className: "recipe-app"}, 
...
},{"./RecipeList":4,"./SearchForm":5,"react":161}],4:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
...
var RecipeList = React.createClass({displayName: "RecipeList",
	render: function() {
		...
		if (!recipes) {
			return (
				React.createElement("div", {className: "recipe-list empty"}, 
					React.createElement("h2", null, "No recipes")
				)
			);
		} else {
			var list = recipes.map(function(r) {
				return (
					React.createElement(Recipe, {data: r})
				);
			});
...
},{"./Recipe":2,"react":161}],5:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
	...
	render: function() {
		return (
			React.createElement("div", {className: "search-form"}, 
				React.createElement("h2", {style: styles.searchTitle}, "Search Recipes"), 
				React.createElement("form", {className: "form-inline"}, 
					
					React.createElement("div", {className: "form-group"}, 
						React.createElement("input", {type: "text", className: "form-control", placeholder: "Search for a recipe"})
					), 

					React.createElement("button", {type: "button", className: "btn btn-primary"}, "Search")
				)
			)
		);
	}
